//
//  MomentsPhotoCollectionPage.swift
//  ArtShredderUITests
//
...
class MomentsPhotoCollectionPage: ArtShredderPageObject {
    
    override var isDesiredPage: Bool {
        return app.collectionViews.matching(identifier: AXMomentsPhotoCollectionView.PageHeader).element.waitForExistence(timeout: 5)
    }
    ...
    private var backButton: XCUIElement { return app.buttons.matching(identifier: AXMomentsPhotoCollectionView.NavigationBarBackButton).element}
    
    private var cancelButton: XCUIElement { return app.buttons.matching(identifier: AXMomentsPhotoCollectionView.NavigationBarCancelButton).element}
    ...
    @discardableResult
    func assertCancelButtonExists() -> MomentsPhotoCollectionPage {
    ...
    @discardableResult
    func assertBackButtonExists() -> MomentsPhotoCollectionPage {
